...
public class Parser {
	...
	public static String getPathWithinDiffCase(String elementIDFromOriginalCase
		...
		List<Node> sourceElements = sourceDocument.selectNodes("//*[@id='" + elementIDFromOriginalCase + "']");
		...
		List<Node> diffElements = sourceDocument.selectNodes("//a");
			
		//Map<Element,Integer> xPathToMatchesMap = new HashMap<>();
		int maxMatch = 0;
